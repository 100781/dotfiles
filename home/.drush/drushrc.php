...
$options['shell-aliases']['clean-core-dis'] = 'pm-disable -y color,dblog,overlay,toolbar,shortcut,search,dashboard';
$options['shell-aliases']['clean-core-en'] = 'pm-enable -y syslog, simpletest';
$options['shell-aliases']['agg-css-off'] = 'variable-set -y --always-set preprocess_css 0';
$options['shell-aliases']['agg-css-on'] = 'variable-set -y --always-set preprocess_css 1';
$options['shell-aliases']['agg-js-off'] = 'variable-set -y --always-set preprocess_js 0';
$options['shell-aliases']['agg-js-on'] = 'variable-set -y --always-set preprocess_js 1';
 ...
 */
$options['result-file'] = '/tmp/@DATABASE_@DATE.sql';
...
// Always use "working copy" with drush make so that .git folders are not
// removed.
$command_specific['make'] = array('working-copy' => TRUE, 'no-gitinfofile' => TRUE);
